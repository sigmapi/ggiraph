...
#' @title Generate interactive grob round rectangles
#' @description This function can be used to generate interactive grob
#' round rectangles.
#'
...
#' @param data_id identifiers to associate with rectangles
#' @export
interactive_roundrect_grob <- function(x=unit(0.5, "npc"), y=unit(0.5, "npc"),
    width=unit(1, "npc"), height=unit(1, "npc"), r = unit(0.1, "snpc"),
    tooltip = NULL,
    onclick = NULL,
    data_id = NULL,
    just="centre",
